        ...
        <div class="mx-auto flex w-full max-w-3xl flex-col gap-8">
            <header class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    <div
                        class="flex size-10 items-center justify-center rounded-xl bg-emerald-400 text-sm font-bold text-zinc-950 shadow-[0_0_32px_rgba(52,211,153,0.2)]"
                    >
                        FN
                    </div>
                    <div>
                        <p class="font-semibold tracking-tight">Forge Native</p>
                        <p class="text-xs text-zinc-500">{{ copy.tagline }}</p>
                    </div>
                </div>

                <span
                    class="rounded-full border border-zinc-800 bg-zinc-900 px-3 py-1 text-xs text-zinc-400"
                >
                    {{ credentials.length }}
                    {{
            ...
            <section
                class="grid overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900/70 shadow-2xl shadow-black/30 lg:grid-cols-[0.85fr_1.15fr]"
            >
                <div
                    class="flex flex-col justify-between gap-8 border-b border-zinc-800 bg-zinc-900 p-7 lg:border-r lg:border-b-0"
                >
                    <div class="flex flex-col gap-4">
                        <span
                            class="w-fit rounded-full bg-emerald-400/10 px-3 py-1 text-xs font-medium text-emerald-300"
                        >
                            {{ copy.setup_badge }}
                        </span>
                    ...
                    <div class="flex gap-3 text-xs leading-5 text-zinc-500">
                        <svg
                ...
                >
                    <div class="flex flex-col gap-2">
                        ...
                        <input
                            ...
                            class="h-11 rounded-xl border border-zinc-700 bg-zinc-950/70 px-3.5 text-sm text-white transition outline-none placeholder:text-zinc-600 focus:border-emerald-400 focus:ring-3 focus:ring-emerald-400/10"
                        />
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <textarea
                            ...
                            class="min-h-32 resize-y rounded-xl border border-zinc-700 bg-zinc-950/70 px-3.5 py-3 font-mono text-sm break-all text-white transition outline-none placeholder:font-sans placeholder:text-zinc-600 focus:border-emerald-400 focus:ring-3 focus:ring-emerald-400/10"
                        />
            ...
            <section v-if="credentials.length" class="flex flex-col gap-3">
                ...
                <div class="grid gap-3 sm:grid-cols-2">
                    <Link
                        ...
                        class="flex items-center gap-3 rounded-2xl border bg-zinc-900/60 p-4 transition data-loading:opacity-60"
                        :class="
                    ...
                    >
                        <span
                            class="flex size-9 shrink-0 items-center justify-center rounded-xl bg-zinc-800 text-sm font-semibold text-emerald-300"
                        >
                        ...
                        <span
                            ...
                            class="ml-auto rounded-full bg-emerald-400/10 px-2 py-1 text-[10px] font-medium text-emerald-300"
                        >
                            {{ copy.current_connection }}
                        </span>
                        <svg
                            v-else
                            class="ml-auto size-4 shrink-0 text-zinc-600"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                            stroke-width="1.8"
                        ...
                        <button
                            ...
                            :class="
                                currentLocale === language.locale
                                    ...
                                    : 'border-zinc-800 bg-zinc-900/60 text-zinc-300 hover:border-zinc-700 hover:bg-zinc-900 disabled:opacity-60'
                            "
                        >
